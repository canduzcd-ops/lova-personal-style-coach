...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className="mb-6 group">
      <label className="block text-[10px] font-bold text-secondary dark:text-secondary-dark uppercase tracking-[0.2em] mb-2 ml-1 transition-colors group-focus-within:text-primary dark:group-focus-within:text-primary-dark">
        {label}
      </label>
