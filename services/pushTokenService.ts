 ...
 */
export function getDocId(uid: string, platform: 'ios' | 'android'): string {
 ...
 */
export async function disableToken(params: DisableTokenParams): Promise<void> {
