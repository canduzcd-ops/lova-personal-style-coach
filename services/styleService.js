...
const calculateCompatibility = (item1, item2, targetStyle) => {
    ...
    if (dna) {
        ...
        if (i1Matches && i2Matches)
            score += 5; // High stylistic coherence
...
export const generateSmartOutfit = async (user, wardrobe) => {
