        ...
        if (platform === 'android') {
            ...
            try {
                ...
                if (errorMessage.includes('BillingUnavailable') ||
                    ...
                    throw new Error('Bu uygulama henüz Google Play faturalandırması için yapılandırılmamış.\n\n' +
                ...
                if (errorMessage.includes('DeveloperError')) {
                    throw new Error('Geliştirici yapılandırma hatası. Play Console\'daki ürün ID\'lerini kontrol edin.');
                }
